...
class AnchorProcessor:
    ...
    def _take_anchor_overview_screenshot(self):
        ...
        self.current_data["行业标签"] = find_ancestor_texts_with_value(self.anchor_page, "合作行业", anchor_overview_wrapper)
        self.current_data["合作报价"] = find_ancestor_texts_with_value(self.anchor_page, "图文笔记一口价", anchor_overview_wrapper)
    ...
    def _take_anchor_fans_screenshot(self):
        ...
        self.current_data["性别"] = find_ancestor_texts_with_value(self.anchor_page, "性别分布", anchor_overview_wrapper)
        self.current_data["年龄"] = find_ancestor_texts_with_value(self.anchor_page, "年龄分布", anchor_overview_wrapper)
        self.current_data["地域"] = find_ancestor_texts_with_value(self.anchor_page, "地域分布", anchor_overview_wrapper)
