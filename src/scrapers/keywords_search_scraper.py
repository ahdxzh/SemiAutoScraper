...
class KeywordsSearchScraper:
    ...
    def _search_keywords(self, keywords: str):
        ...
        self.page.get_by_role("textbox", name="按内容关键词找达人").fill(keywords)
        self.page.get_by_role("textbox", name="按内容关键词找达人").press("Enter")
        print(f"===== 休眠{self.SEARCH_WAIT_SECONDS}秒等待用户自行调整筛选参数' =====")
    ...
    def _process_single_page(self, page_number, processor, limit_start, limit_end, current_rank):
        ...
        try:
            ...
            # 页面准备操作
            page.get_by_text(self.PAGE_TEXT).first.click()
